...
def load_local_documents():
    ...
    manual_docs = [
        ...
        Document(page_content="Accenture reported record new bookings of $22.1 billion for Q2 FY26[cite: 26, 31]."),
        Document(page_content="Accenture's Q2 FY26 revenues reached $18.0 billion, an 8% increase[cite: 34, 53]."),
        Document(page_content="CEO Julie Sweet noted significant AI-driven growth[cite: 30, 31]."),
        Document(page_content="Accenture declared a dividend of $1.63 per share, a 10% increase[cite: 82, 85]."),
        Document(page_content="Narayanan Selvaraj is a Team Lead at Accenture (9.5+ years exp) specializing in Full-Stack LLM and ReactJS[cite: 2, 14, 19]."),
        Document(page_content="Dikshitha is an 11-year-old girl at Prince Srivari School (7th Std, Sec A). She loves playing and prawns.")
    ]
