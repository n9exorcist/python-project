// SAST fixes: (1) getSafeErrorMessage() helper centralises CWE-209 mitigation
// (2) JSON.stringify(error) replaced with getSafeErrorMessage() throughout
// (3) Raw error objects never rendered directly in JSX
// (4) peerFinancialData.error rendered safely — no raw object exposure
// (5) Benchmarking error objects rendered safely
...
// FIX #2 — Centralised safe error message helper (CWE-209 Information Exposure).
// Replaces every JSON.stringify(error) call in JSX.
// RTK Query errors have shape { status, data: { message } }.
// Plain string errors are returned as-is. Objects are sanitised.
...
export default function getTabConfig({
  ...
  const renderMaturitySpider = () => {
    ...
    if (error) {
      // FIX #7 — raw error object never passed to JSX; sanitised message only.
      return (
          ...
          <div className="slide">
            {selectedKPI === "OTIF" ? (
              waterfallLoading ? (
                ...
                // FIX #3 — raw error never interpolated; sanitised string only.
            ...
            {selectedKPI === "OTIF" ? (
              <>
                ...
                {heatmapLoading ? (
                  ...
                  // FIX #6 — heatmapError sanitised; was JSON.stringify(heatmapError).
                  <div key="error" className="alert alert-danger" role="alert">
    ...
    "kpi-benchmarking": [
      {
        ...
        description: benchmarkingData?.benchmarkingOne?.isLoading ? (
          ...
          // FIX #5 — benchmarking error sanitised; was raw object interpolation.
          <div className="alert alert-danger" role="alert">
      ...
      },
      {
        ...
        description: benchmarkingData?.benchmarkingTwo?.isLoading ? (
          ...
          // FIX #5 — benchmarking error sanitised.
          <div className="alert alert-danger" role="alert">
        ...
        description: (
          <div className="container mt-4 px-0">
            ...
            {loading ? (
              ...
              // FIX #2 — JSON.stringify(error) replaced with getSafeErrorMessage().
              <div className="alert alert-danger" role="alert">
                {getSafeErrorMessage(error)}
              </div>
    ...
    "peer-financial-analysis": [
      {
        ...
        description: peerFinancialData?.error ? (
          // FIX #4 — peerFinancialData.error sanitised; was raw object interpolation.
          <div className="alert alert-danger" role="alert">
      ...
      },
      {
        ...
        description: peerFinancialData?.error ? (
          // FIX #4 — peerFinancialData.error sanitised.
          <div className="alert alert-danger" role="alert">
            {getSafeErrorMessage(peerFinancialData.error)}
          </div>
